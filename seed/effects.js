  ...
  const effects = [
    {
      ...
      code: "B3K",
      description:
        "A defined and powerful overdrive, with a simple layout, it sets no boundaries or rules to unleashing the desired tone.",
    ...
    },
    {
      ...
      code: "TUBE",
      description:
        "Clean American tube preamp with 3-band equalizer and volume controls",
